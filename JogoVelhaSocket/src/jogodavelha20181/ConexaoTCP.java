...
public class ConexaoTCP extends SwingWorker<Boolean, String> {
    ...
    public ConexaoTCP (TelaJogo mainFrame, Socket socket)
    {
        ...
        {
            mainFrame.mostraMensagem(TelaJogo.MSG_ERRO,
                            TelaJogo.MSG_PROTO_TCP,
        ...
        while(true)
        {
            try
            {
                ...
                if (msg != null)
                {
                    ...
                    switch(nMsg)
                    {
                        ...
                        case 8:
                            ...
                            pos = Integer.parseInt(complemento);
                            if((pos > 0) && (pos < 10))
                                mainFrame.marcaPosicao(TelaJogo.JOGADOR_REMOTO, pos);
                            break;
                        ...
                        case 10: 
                            mainFrame.encerrarConexaoTCP(TelaJogo.JOGADOR_DESISTIU);
                            break;
                ...
                else
                {
                    ...
                    mainFrame.encerrarConexaoTCP(TelaJogo.CONEXAO_PERDIDA);
    ...
    public boolean enviarMensagemTCP(int numero, String compl)
    {
        ...
        try
        {
            ...
            mainFrame.mostraMensagem(TelaJogo.MSG_OUT,
                            TelaJogo.MSG_PROTO_TCP,
                            socket.getRemoteSocketAddress().toString(),
                            socket.getPort(), msg);
